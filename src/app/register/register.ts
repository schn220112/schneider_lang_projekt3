...
export class Register {
  ...
  async onSubmit(event: Event) {
    ...
    if (role === 'Schüler') {
      ...
      profilDaten.geburtsdatum = (document.getElementById('schuelerGeburtsdatum') as HTMLInputElement).value;
      profilDaten.klasse       = (document.getElementById('schuelerKlasse') as HTMLInputElement).value.trim();
      profilDaten.abteilung    = (document.getElementById('schuelerAbteilung') as HTMLSelectElement).value;
      ...
      profilDaten.geburtsdatum = (document.getElementById('lehrerGeburtsdatum') as HTMLInputElement).value;
      profilDaten.abteilung    = (document.getElementById('lehrerAbteilung') as HTMLSelectElement).value;
